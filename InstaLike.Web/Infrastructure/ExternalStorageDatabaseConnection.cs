...
namespace InstaLike.Web.Infrastructure
{
    ...
    internal class ExternalStorageDatabaseConnection : DbConnection, IExternalStoragePictureProvider
    {
        ...
        public ExternalStorageDatabaseConnection(DbConnection database, IExternalStoragePictureProvider externalStorage)
        {
        ...
        {
            return new ExternalStorageDatabaseCommand(this, DatabaseConnection.CreateCommand());
        }
