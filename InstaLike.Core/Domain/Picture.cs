...
namespace InstaLike.Core.Domain
{
    public class Picture : ValueObject
    {
        ...
        private const string Default_Profile_Picture_Guid = "00010000-0000-0000-0000-000000000000";
        ...
        public static Picture DefaultProfilePicture =>
            Create(Convert.FromBase64String(Default_Profile_Picture_Base64), new Guid(Default_Profile_Picture_Guid))
            .Value;

        public static Picture EmptyPicture =>
            Create(Convert.FromBase64String(Empty_Picture_Base64), new Guid(Empty_Picture_Guid))
            .Value;

        public static Picture MissingPicture =>
            Create(Convert.FromBase64String(Missing_Picture_Base64), new Guid(Missing_Picture_Guid))
            .Value;
